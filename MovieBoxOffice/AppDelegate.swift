...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func uiSetting(){
        UINavigationBar.appearance().barTintColor = #colorLiteral(red: 0.335427016, green: 0.4181476831, blue: 0.7686859965, alpha: 1)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MovieBoxOffice")
